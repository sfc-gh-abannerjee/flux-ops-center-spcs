...
RUN echo 'server { \n\
    ...
    gzip_proxied any; \n\
    \n\
    add_header Content-Security-Policy "default-src '\''self'\'' '\''unsafe-inline'\'' '\''unsafe-eval'\'' blob: data:; connect-src '\''self'\'' https://*.cartocdn.com https://*.basemaps.cartocdn.com https://*.mapbox.com https://*.snowflakecomputing.com https://unpkg.com; style-src '\''self'\'' '\''unsafe-inline'\'' https://*.cartocdn.com https://*.basemaps.cartocdn.com https://fonts.googleapis.com https://unpkg.com; style-src-elem '\''self'\'' '\''unsafe-inline'\'' https://*.cartocdn.com https://*.basemaps.cartocdn.com https://fonts.googleapis.com https://unpkg.com; font-src '\''self'\'' https://fonts.gstatic.com https://fonts.googleapis.com https://*.basemaps.cartocdn.com data:; img-src '\''self'\'' data: https://*.cartocdn.com https://*.basemaps.cartocdn.com https://*.mapbox.com blob:; worker-src '\''self'\'' blob: https://unpkg.com; script-src '\''self'\'' '\''unsafe-eval'\'' https://unpkg.com;" always; \n\
    \n\
