...
CREATE TABLE IF NOT EXISTS NODE_CENTRALITY_FEATURES_V2 (
    ...
    PAGERANK FLOAT,  -- Backend expects PAGERANK (alias)
    EIGENVECTOR_CENTRALITY FLOAT,  -- Graph centrality measure
...
INSERT INTO GRID_NODES (NODE_ID, NODE_TYPE, NODE_NAME, LATITUDE, LONGITUDE, LAT, LON, VOLTAGE_LEVEL, VOLTAGE_KV, CAPACITY_KVA, CAPACITY_KW, SUBSTATION_ID, DEGREE_CENTRALITY, BETWEENNESS_CENTRALITY, LOAD_FACTOR, HEALTH_SCORE, CRITICALITY_SCORE, DOWNSTREAM_TRANSFORMERS, DOWNSTREAM_CAPACITY_KVA)
SELECT 
    TRANSFORMER_ID,
    'TRANSFORMER',
    TRANSFORMER_NAME,
