...
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  flux-utility-solutions (Deploy First)                                      │
│  ├── Creates: FLUX_DB database                                              │
│  ├── Creates: PRODUCTION schema (core tables)                               │
│  ├── Creates: APPLICATIONS schema (views for Ops Center)                    │
│  ├── Creates: ML_DEMO schema (transformer prediction)                       │
│  ├── Creates: CASCADE_ANALYSIS schema (GNN tables - empty)                  │
│  ├── Creates: Cortex Agent (grid_intelligence_agent)                        │
│  └── Creates: Semantic Model for natural language queries                   │
│                                                                             │
│  flux-data-forge (Optional)                                                 │
│  ├── Generates: Synthetic AMI streaming data                                │
│  └── Populates: Real-time meter readings in PRODUCTION schema               │
│                                                                             │
│  flux-ops-center-spcs (This Repo)                                           │
│  ├── Reads: All schemas created by flux-utility-solutions                   │
│  ├── Requires: Snowflake Postgres with PostGIS data                         │
│  └── Provides: Visualization layer (no data creation)                       │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
...
│                                                                             │
│  Note: Standalone is self-contained but has reduced AI features             │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
